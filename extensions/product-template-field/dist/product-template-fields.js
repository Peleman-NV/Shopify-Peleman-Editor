(() => {
  ...
  // extensions/product-template-field/src/ActionExtension.jsx
  ...
  // extensions/product-template-field/src/utils.js
  function updateTemplates(id, newTemplates) {
    return __async(this, null, function* () {
  ...
  function getTemplates(productId) {
    return __async(this, null, function* () {
      var _a, _b, _c;
  ...
  function generateId(allTemplates) {
    return !(allTemplates == null ? void 0 : allTemplates.length) ? 0 : allTemplates[allTemplates.length - 1].id + 1;
  }
  function validateForm({ title, imageUploadsEnabled, minImagesUpload, maxImagesUpload }) {
    ...
    if (imageUploadsEnabled) {
      ...
      if (isNumber(minImagesUpload) && isNumber(maxImagesUpload) && Number(maxImagesUpload) < Number(minImagesUpload)) {
  ...
  function App() {
    ...
    const [template, setTemplate] = (0, import_react13.useState)({ title: "", colorCode: "", imageUploadsEnabled: "", minImagesUpload: "", maxImagesUpload: "" });
    const [allTemplates, setAllTemplates] = (0, import_react13.useState)([]);
    ...
    (0, import_react13.useEffect)(() => {
      getTemplates(data.selected[0].id).then((templates) => {
        var _a, _b, _c;
        const existing = templates == null ? void 0 : templates[0];
        if (existing) {
          setTemplate({
            title: existing.title || "",
            colorCode: existing.colorCode || "",
            imageUploadsEnabled: (_a = existing.imageUploadsEnabled) != null ? _a : false,
            minImagesUpload: ((_b = existing.minImagesUpload) == null ? void 0 : _b.toString()) || "",
            maxImagesUpload: ((_c = existing.maxImagesUpload) == null ? void 0 : _c.toString()) || ""
          });
        }
    ...
    const onSubmit = (0, import_react13.useCallback)(() => __async(this, null, function* () {
      ...
      if (!isValid) return;
      const existing = allTemplates == null ? void 0 : allTemplates[0];
      const updatedTemplate = __spreadValues(__spreadValues({}, existing ? { id: existing.id } : { id: generateId(allTemplates) }), template);
      yield updateTemplates(data.selected[0].id, [updatedTemplate]);
      close();
    }), [template, data.selected, allTemplates, close]);
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      AdminAction2,
      {
        title: "Add a template ID",
        primaryAction: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button2, { onPress: onSubmit, children: "Add template ID" }),
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            TextField2,
            {
              label: "Template ID",
              value: title,
              error: (formErrors == null ? void 0 : formErrors.title) ? "Please enter a template ID" : void 0,
              onChange: (val) => setTemplate((prev) => __spreadProps(__spreadValues({}, prev), { title: val }))
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { paddingBlockStart: "base" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            TextField2,
            {
              label: "Color Code (optional)",
              value: colorCode,
              onChange: (val) => setTemplate((prev) => __spreadProps(__spreadValues({}, prev), { colorCode: val }))
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { paddingBlockStart: "base" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            Checkbox2,
            {
              ...
              onChange: (val) => setTemplate((prev) => __spreadProps(__spreadValues({}, prev), {
          ...
          imageUploadsEnabled && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { paddingBlockStart: "base" }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              TextField2,
              {
                ...
                error: (formErrors == null ? void 0 : formErrors.minImagesUpload) || void 0,
                onChange: (val) => setTemplate((prev) => __spreadProps(__spreadValues({}, prev), { minImagesUpload: val }))
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { paddingBlockStart: "base" }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              TextField2,
              {
                ...
                error: (formErrors == null ? void 0 : formErrors.maxImagesUpload) || void 0,
                onChange: (val) => setTemplate((prev) => __spreadProps(__spreadValues({}, prev), { maxImagesUpload: val }))
              }
            )
          ] })
        ]
...
//# sourceMappingURL=product-template-fields.js.map
