(() => {
  ...
  // extensions/product-template-tracker/src/BlockExtension.jsx
  ...
  // extensions/product-template-tracker/src/utils.js
  ...
  function App() {
    ...
    const [templates, setTemplates] = (0, import_react17.useState)([]);
    ...
    (0, import_react17.useEffect)(() => {
      (function getProductInfo() {
        return __async(this, null, function* () {
          var _a, _b, _c;
          const productData = yield getTemplates(productId);
          setLoading(false);
    ...
    const paginatedTemplates = (0, import_react17.useMemo)(() => {
    ...
    const handleDelete = (id) => __async(this, null, function* () {
      ...
      yield updateTemplates(productId, newTemplates);
    });
    const onSubmit = () => __async(this, null, function* () {
      yield updateTemplates(productId, templates);
    });
    const onReset = () => {
    };
    return loading ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(InlineStack2, { blockAlignment: "center", inlineAlignment: "center", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ProgressIndicator2, { size: "large-100" }) }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      AdminBlock2,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Form2, { id: `templates-form`, onSubmit, onReset, children: templates.length ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
                  ...
                  InlineStack2,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Box2, { inlineSize: "53%", children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { inlineSize: "100%", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { textOverflow: "ellipsis", children: colorCode }) })
                      ] }),
                      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { inlineSize: "22%" }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { paddingBlockEnd: "large", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { fontWeight: "bold", children: "This product doesn\u2019t have a template connected." }) }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            Button2,
            {
              onPress: () => navigation == null ? void 0 : navigation.navigate(`extension:product-template-fields`),
              children: "Add a template"
            }
          )
        ] }) })
      }
...
//# sourceMappingURL=product-template-tracker.js.map
